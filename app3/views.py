...
def perm_input(request):
    return render(request, 'app3/perm_input.html')
...
def display_permutations(request):
    if request.method == 'POST':
        ...
        if word:
            ...
            return render(request, 'app3/perm_result.html', {'word': word, 'permutations': perm_list})
        else:
            return render(request, 'app3/perm_error.html')
    else:
        return render(request, 'app3/perm_input.html')